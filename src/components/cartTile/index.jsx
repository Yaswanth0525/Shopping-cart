        ...
        <div className="ml-auto">
          ...
          <div className="mt-3">
            <button
              ...
              className="disabled:opacity-65 border border-[#000] py-2 px-3 border-none bg-gray-300 text-black mr-2"
            ...
            <button
              ...
              className="border border-[#000] py-2 px-3 border-none bg-gray-300 text-black"
            >
              +
            </button>
          </div>
