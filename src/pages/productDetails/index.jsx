...
function ProductDetailsPage() {
  ...
  return (
    <div>
      <div className="p-6 lg:max-w-4xl max-w-2xl mx-auto">
          ...
          <div className="lg:col-span-2">
            ...
            <div>
              ...
              <div>
                ...
                onClick={()=>handleAddToCart(productDetails)} className="disabled:opacity-65 mt-5 min-w-[200px] px-4 py-3 border border-[#333] bg-transparent text-sm font-semibold rounded-full">Add to Cart</button>
              </div>
            </div>
          </div>
        </div>
